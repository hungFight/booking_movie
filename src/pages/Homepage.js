                ...
                <Box className="px-28 mt-10">
                    ...
                    <Box>
                        <Grid container spacing={1}>
                            {movies.map(r =>
                                <Grid item xs={3} sx={{ display: 'flex', flex: 'flex-wrap', width: '100%' }}>
                                    <Link key={r.id} to={`/movie/detail?id=${r.id}`}>
                                        <Card className="shadow-none">
                                            <CardMedia
                                                ...
                                                image={`http://localhost:8081/api/movie/images?imageName=${r.image}`}
                                            >
